...
export default function ProductoPage() {
  ...
  useEffect(() => {
    ...
    const timer = setTimeout(() => {
      const productoEncontrado = productosDB.find((p) => p.id === Number.parseInt(params.id as string))
      ...
      <header className="bg-white border-b border-gray-200">
        <div className="container mx-auto px-6 py-8 flex items-center justify-between">
          <div className="flex items-center space-x-3">
            <Link href="/ofertas" className="flex items-center space-x-2 text-gray-600 hover:text-gray-800">
          ...
          <div className="min-h-[300px]">
            ...
            {tabActiva === "reseñas" && (
              <div className="space-y-6">
                ...
                {/* Lista de reseñas */}
                <div className="space-y-6">
                  {producto.reseñas.map((reseña: any) => (
