...
export default function OfertasPage() {
  // Se eliminaron los estados relacionados con la vista rápida
  ...
  // Se eliminó la sección de tipos de oferta

  // Se eliminaron las funciones relacionadas con la vista rápida

  const calcularAhorro = (precioOriginal: number, precioOferta: number) => {
    return precioOriginal - precioOferta
  }

  // Se eliminó la función de renderizado del modal de vista rápida

  return (
    <div className="ofertas-page">
      {/* Se eliminó el renderizado del modal */}
      {/* Header */}
      ...
      {/* Se eliminó la sección de filtros por tipo de oferta */}
            ...
            {ofertas.map((producto) => {
              ...
              return (
                <div key={producto.id} className="product-card">
                  ...
                  {/* Se eliminó el botón de vista rápida */}
                </div>
              )
            })}
          </div>
