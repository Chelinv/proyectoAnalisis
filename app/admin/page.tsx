    ...
    switch (seccionActiva) {
      case "productos":
        ...
        columnas = [
          ...
          { key: "precio", label: "Precio", format: (val: number) => `$${val.toFixed(2)}` },
          { key: "stock", label: "Stock", format: (val: number) => `${val} unidades` },
        ]
        break
      ...
      case "ventas":
        ...
        columnas = [
          ...
          { key: "total", label: "Total", format: (val: number) => `$${val.toFixed(2)}` },
          { key: "fecha", label: "Fecha" },
          {
            key: "estado",
            label: "Estado",
